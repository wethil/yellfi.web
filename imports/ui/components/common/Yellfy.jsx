...
//found it !! yellfy. but svenja, you are missed.
 class Yellfy extends Component {
...
getSuggestionsFromCloud(plan,keywords,formattedKeywords,data,chosenIndex,yellId,suggestionCoord){
    	...
    	if (formattedKeywords.trim()!="") {
	     ...
	     query = data.title ? `${keywords}|${qWords}|${data.title}` :`${keywords}|${qWords}`
	    ...
	    case 2://reading something
	    	...
	    	lang=i18n.getLocale()
	        query = `&q=${qWords}&langRestrict=${lang}`
